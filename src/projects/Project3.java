...
class Library {
    ...
    private Book[][] shelves = new Book[10][4];
...
//        System.out.println("Creating a Book object with title: " + title + ", author: " + author + ", totalCopies: " + totalCopies);
...
//            if (shelves[i][j] != null && shelves[i][j].getTitle().equalsIgnoreCase(title) && shelves[i][j].getAuthor().equalsIgnoreCase(author)) {
